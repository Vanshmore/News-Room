var url = "https://newsapi.org/v2/everything?q=politics&apiKey=a63eff55710e40b39e62354524e0f8a3";
var articles = null;
politicsSection = document.getElementById("politicsSection");
fetch(url)
    .then(function(response) {
        ...
        politicsSection.innerHTML = newHTML;    
});
