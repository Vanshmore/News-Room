var url = "https://newsapi.org/v2/everything?q=bollywood&apiKey=a63eff55710e40b39e62354524e0f8a3";
var articles = null;
bollywoodSection = document.getElementById("bollywoodSection");
fetch(url)
    .then(function(response) {
        ...
        bollywoodSection.innerHTML = newHTML;    
});
