var url = "https://newsapi.org/v2/everything?q=india&apiKey=a63eff55710e40b39e62354524e0f8a3";
var articles = null;
indiaSection = document.getElementById("indiaSection");
fetch(url)
    .then(function(response) {
        ...
        indiaSection.innerHTML = newHTML;    
});
