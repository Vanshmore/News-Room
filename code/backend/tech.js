var url = "https://newsapi.org/v2/everything?q=technology&apiKey=a63eff55710e40b39e62354524e0f8a3";
var articles = null;
techonogySection = document.getElementById("techonologySection");
fetch(url)
    .then(function(response) {
        ...
        techonogySection.innerHTML = newHTML;    
});
