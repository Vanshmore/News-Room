var url = "https://newsapi.org/v2/everything?q=culture&apiKey=a63eff55710e40b39e62354524e0f8a3";
var articles = null;
cultureSection = document.getElementById("cultureSection");
fetch(url)
    .then(function(response) {
        ...
        cultureSection.innerHTML = newHTML;    
});
