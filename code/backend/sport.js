var url = "https://newsapi.org/v2/everything?q=sports&apiKey=a63eff55710e40b39e62354524e0f8a3";
var articles = null;
sportsSection = document.getElementById("sportSection");
fetch(url)
    .then(function(response) {
        ...
        sportsSection.innerHTML = newHTML;    
});
